            ...
            <div className="flex flex-col gap-2 w-full">
              <div className="flex flex-wrap gap-2">
                <input
                  ...
                  className="border border-border rounded-md px-2 py-1 flex-grow min-w-[70px] max-w-[200px] md:max-w-[100px]"
                />
                <button
                  onClick={handleSave}
                  disabled={isSaving}
                  className="px-4 py-1 flex justify-center bg-accent text-white rounded-md hover:bg-accent-hover transition"
                >
                  {isSaving ? (
