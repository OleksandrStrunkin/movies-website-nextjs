...
export default function TopDayItems({
  poster,
  title,
  id,
  overview,
...
const formattedDate = dateObject.toLocaleDateString('en-GB', options);
  ...
  return (
    <li
      key={id}
      className="flex relative justify-center overflow-hidden w-full h-96 mt-8 border border-slate-600 rounded-md group hover:border-current transform duration-500"
    >
      <Link href={`${adress}/${id}`}>
        <div className="">
          <img
